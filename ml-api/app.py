...
CONDITION_DESCRIPTIONS = {
    ...
    'G6PD_Deficiency': 'Enzyme deficiency that can trigger anemia episodes after certain foods, infections, or medications.',
...
def predict():
    ...
    raw_prediction = le.inverse_transform(prediction_idx)[0]
    normalized_prediction = CONDITION_ALIASES.get(raw_prediction, raw_prediction)
    
    # Get confidence score for the predicted class
    confidence = float(prediction_proba[prediction_idx[0]])
